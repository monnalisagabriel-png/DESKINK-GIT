            ...
            <div className="bg-bg-secondary p-4 md:p-6 rounded-lg border border-border flex flex-col overflow-hidden">
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <button
                        ...
                        disabled={generating}
                        className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-bg-tertiary text-text-primary hover:text-text-primary py-3 rounded-lg border border-dashed border-border transition-all"
                    >
                        {generating ? (
